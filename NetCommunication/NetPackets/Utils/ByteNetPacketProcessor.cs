...
{
	public class ByteNetPacketProcessor
    {    
        ...
        public ByteNetPacketProcessor()
        {
            _netSerializer = new NetSerializer();
        }

        public ByteNetPacketProcessor(int maxStringLength)
        {
            _netSerializer = new NetSerializer(maxStringLength);
        }

        public void RegisterType<T>() where T : class, INetSerializable
        {
        ...
        public void RegisterType(Type type)
        {
            ...
            {
                throw new Exception("Type shuld be implement INetSerializable");
            }
        ...
        {
            if (_typesIds.TryGetValue(typeof(T), out var id))
            {
                return id;
            }

            Console.WriteLine($"GetHash: {typeof(T).FullName}");
            throw new Exception($"GetHash: {typeof(T).FullName}");
        }
